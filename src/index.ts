...
// Moltbook and Clawstr integrations removed — leaked AUTH_MASTER_KEY via status tools
...
async function main(): Promise<void> {
  ...
  // === Moltbook & Clawstr integrations REMOVED (security incident — leaked AUTH_MASTER_KEY) ===
  ...
  // Moltbook and Clawstr agents disabled (security incident — removed)
...
// Moltbook and Clawstr exports removed (security incident)
